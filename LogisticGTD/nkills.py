...
for i,test in enumerate(test_x):
    if(test<3):
            print("nkill: ",test," --> Prob of Firearms attack: ",h(test,w,b)," actual is: ",test_y[i])

#Test
y_axis = np.arange(0,2000,1)
plt.plot(y_axis,h(y_axis,w,b),'g--')
plt.ylabel('Numbers Of Killed')
